...
export const editStudentCard = async (req, res) => {
  ...
  const params = {
    ...
    Key: `${firstName}_${lastName}_profile_image.png`,
    Body: imageBuffer,
  ...
  try {
    ...
    const profileUrl = `https://${process.env.AWS_BUCKET_NAME_2}.s3.${process.env.AWS_REGION}.amazonaws.com/${firstName}_${lastName}_profile_image.png`;
